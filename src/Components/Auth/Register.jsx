...
const Register = () => {
    ...
    return (
        <div className="relative min-h-[calc(100vh-72px)] overflow-hidden bg-[#f8fafc] px-4 py-8 sm:py-10">
            ...
            <div className="relative mx-auto grid w-full max-w-5xl overflow-hidden rounded-[32px] border border-white bg-white shadow-2xl shadow-slate-200/70 lg:grid-cols-2">
